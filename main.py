...
from data_seperate import SeperateData, import_data_seperated
...
###########################    Step 2 : Train Model   ##############################
    ...
    ################## 2020-08-04 ########################
    SeperateData(dir_save_feature,fn_feature)
    ################## 2020-08-04 ########################
...
#    print("\n >>>>>> Extract Test Feature !!!!!!  Suceess  !!!!!! \n") 
    ...
    ################# 2020-08-04 ########################
    X_train, X_test, y_train, y_test = import_data_seperated(dir_save_feature)
    ################## 2020-08-04 ########################
