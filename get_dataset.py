...
class GetHoopPos:
    def __init__(self,fn_video,crop_size):
        self.dir_video = '.\\' + fn_video
        self.crop_size = crop_size
        self.cap = cv2.VideoCapture(self.dir_video) 
...
class GetDataset:
    def __init__(self,fn_video,save_data_path, save_data_npy, dir_pos, dir_neg, crop_size, hoop_pos,colume):
        
        self.dir_video = '.\\' + fn_video
        self.save_data_npy = save_data_npy
...
class create_annotation():
    ...
    def __init__(self,dir_pos, dir_neg, fn_annotation, save_label_npy, save_data_npy, crop_size, colume):
        self.dir_pos = dir_pos
        self.dir_neg = dir_neg
        self.save_annotation_dir = '.\\' + fn_annotation
        self.save_label_npy = save_label_npy
        ...
        self.dataset = np.load(save_data_npy)
